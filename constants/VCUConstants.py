...
class VCUConstants:
    ...
    button_map: dict =      field(default_factory=lambda: {
                                "sendAPPSHSignal":      ("DREW_CMD_APP1_THRESHOLD",),
                                "sendAPPSLSignal":      ("DREW_CMD_APP1_THRESHOLD"),
                                "sendAPPSHSignal_2":    ("DREW_CMD_APP2_THRESHOLD"),
                                "sendAPPSLSignal_2":    ("DREW_CMD_APP2_THRESHOLD"),
                                ...
                                "sendAPPSHFault":       ("DREW_CMD_APP1_THRESHOLD"),
                                "sendAPPSLFault":       ("DREW_CMD_APP1_THRESHOLD"),
                                "sendAPPSHFault_2":     ("DREW_CMD_APP2_THRESHOLD"),
                                "sendAPPSLFault_2":     ("DREW_CMD_APP2_THRESHOLD"),
